// Datei: rss-ticker.js  (keine <script>-Tags in der Datei!)
class RssTicker extends HTMLElement {
  static get observedAttributes() { return ["rss","speed","maxitems","separator","dark","jsonproxy"]; }
  constructor() {
    super();
    this.attachShadow({ mode: "open" });
    this.state = { rss:"", speed:60, maxItems:15, separator:" • ", dark:false, jsonProxy:"" };
  }
  ...
  async render() {
    ...
    try {
      ...
      const seconds = Math.max(20, speed||60, Math.round(charCount/6));
